...
Section equivalences.
  ...
  Proof.
    induction t, l, d.
    exact (transport (fun z => square 1 1 z 1) (cancelL idpath idpath r p) id_square).
  Defined.
  ...
  Proof.
    induction s, l.
    exact (transport (fun z => square idpath idpath z idpath) h id_square).
  Defined.
  ...
  Proof.
    induction t, l, d.
    exact (transport (fun z => square idpath idpath z idpath) (path_over_to_path q) id_square).
  Defined.
...
Section operations.
  ...
  Proof.
    induction p ; cbn in *.
    exact (concat_1p r @ q^ @ (concat_p1 l)^).
  Defined.
