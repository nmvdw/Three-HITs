...
Recall syntax, define colimit, interval, homotopy pushout.

\section{The Approximator}
Given a HIT, define a sequence $F : \mathbb{N} \rightarrow Type$ (approximator), and approximations $F n$ for $n : \mathbb{N}$.
