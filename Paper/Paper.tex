...
%}
%\]
%On the second coordinate it commutes by definition and on the first it commutes by how $F(n+2)$ was defined.
...
\begin{proof}
This is the most difficult one, because colimits only commute with products if there are exponentials.
\end{proof}
